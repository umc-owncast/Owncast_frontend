...
class SearchTwoAdapter(private val mover: SearchMover) : RecyclerView.Adapter<SearchTwoAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchTwoAdapter.Holder {
        val binding = SearchItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return Holder(binding)
    }

    override fun onBindViewHolder(holder: SearchTwoAdapter.Holder, position: Int) {
